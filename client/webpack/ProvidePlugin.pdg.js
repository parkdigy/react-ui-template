module.exports = {
  ...
  getY: ['@pdg/date-time', 'getY'],
  getYm: ['@pdg/date-time', 'getYm'],
  getYmd: ['@pdg/date-time', 'getYmd'],
  getYmdh: ['@pdg/date-time', 'getYmdh'],
  getYmdhm: ['@pdg/date-time', 'getYmdhm'],
  getYmdhms: ['@pdg/date-time', 'getYmdhms'],
  now: ['@pdg/date-time', 'now'],
  nowJs: ['@pdg/date-time', 'nowJs'],
  nowTime: ['@pdg/date-time', 'nowTime'],
  nowY: ['@pdg/date-time', 'nowY'],
  nowYm: ['@pdg/date-time', 'nowYm'],
  nowYmd: ['@pdg/date-time', 'nowYmd'],
  nowYmdh: ['@pdg/date-time', 'nowYmdh'],
  nowYmdhm: ['@pdg/date-time', 'nowYmdhm'],
  nowYmdhms: ['@pdg/date-time', 'nowYmdhms'],
