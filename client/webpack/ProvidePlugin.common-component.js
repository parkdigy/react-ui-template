...
module.exports = {
  ...
  Div: [path.resolve(__dirname, '../src/component/@Common/index.ts'), 'Div'],
  DivProps: [path.resolve(__dirname, '../src/component/@Common/index.ts'), 'DivProps'],
  ...
  PageRootContainerProps: [path.resolve(__dirname, '../src/component/@Common/index.ts'), 'PageRootContainerProps'],
  ...
  Stack: [path.resolve(__dirname, '../src/component/@Common/index.ts'), 'Stack'],
  StackProps: [path.resolve(__dirname, '../src/component/@Common/index.ts'), 'StackProps'],
  // Texts
  T: [path.resolve(__dirname, '../src/component/@Common/index.ts'), 'T'],
  TProps: [path.resolve(__dirname, '../src/component/@Common/index.ts'), 'TProps'],
};
